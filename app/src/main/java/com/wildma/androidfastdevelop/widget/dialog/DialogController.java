...
public class DialogController {
    ...
    void dealDefaultDialog(IDialog.OnClickListener positiveBtnListener, IDialog.OnClickListener negativeBtnListener, String titleStr, String contentStr,
        ...
        btn_ok = (TextView) dialogView.findViewById(R.id.btn_ok);
        btn_cancel = (TextView) dialogView.findViewById(R.id.btn_cancel);
        View view_line = (View) dialogView.findViewById(R.id.view_line);
        if (btn_ok != null && !TextUtils.isEmpty(positiveStr)) {
            ...
            if (!showBtnLeft) {
                btn_ok.setBackgroundResource(R.drawable.selector_default_dialog_corners);
            }
        }
        if (btn_cancel != null) {
            btn_cancel.setVisibility(showBtnLeft ? View.VISIBLE : View.GONE);
            view_line.setVisibility(showBtnLeft ? View.VISIBLE : View.GONE);
    ...
    public static class SYParams {
        ...
        void apply(DialogController controller) {
            ...
            if (layoutRes > 0) {
                ...
                throw new IllegalArgumentException("CommonDialog View can't be null");
            }
            if (dialogWidth > 0) {
